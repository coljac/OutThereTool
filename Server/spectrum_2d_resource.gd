...
## Dimensions for contamination and model data (may differ from main image)
@export var contam_width: int
@export var contam_height: int
@export var model_width: int
@export var model_height: int
